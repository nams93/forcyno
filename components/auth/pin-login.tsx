...
export function PinLogin() {
  ...
  // Ajouter cette fonction dans le composant PinLogin
      ...
      <CardContent className="p-0">
        <form onSubmit={handleSubmit}>
          ...
          <div className="mt-4 text-center">
            <button type="button" onClick={handleDirectAccess} className="text-sm text-gray-500 hover:text-gray-700">
              Accès temporaire (sans code)
            </button>
          </div>
        </form>
      </CardContent>
